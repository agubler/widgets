...
import { createResourceMiddleware, ResourceMeta } from '../resources';
...
const factory = create({
	...
	theme,
	i18n,
	resources: createResourceMiddleware<ListOption>()
})
...
export const Select = factory(function Select({
	children,
	properties,
	middleware: { icache, focus, theme, i18n, resources }
}) {
	const {
		classes,
		disabled,
	...
	const { options, isLoading, meta, resource, find } = resources();
